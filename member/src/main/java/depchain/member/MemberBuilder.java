...
class MemberBuilder {
    ...
    public static Member build(String name, String address, int port, int behaviour) throws Exception {
        ...
        return switch (behaviour) {
            ...
            case 5 -> new SpamByzantine(config, logger, pf, consensusState, blockchainState, messageQueue, appendQueue);
            case 6 ->
            ...
            default -> new Member(config, logger, pf, consensusState, blockchainState, messageQueue, appendQueue);
        };
    }
